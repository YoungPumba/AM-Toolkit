...
final class UpgradeCoursesProgressSources implements MigrationInterface
{
    public function up(): bool
    {
        ...
        foreach (CoursesSchema::progressSourceDefinitions($wpdb->get_charset_collate()) as $sql) {
            dbDelta($sql);
        }
        ...
        return (new CoursesSchemaVerifier())->verify([
            ...
            CoursesSchema::videoCheckpointsTable() => ['user_lesson_request'],
            CoursesSchema::requirementCompletionsTable() => ['user_lesson_requirement'],
        ]);
    }
}
